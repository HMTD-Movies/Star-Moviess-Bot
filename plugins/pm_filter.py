    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                await message.reply_text(text=f"<b>Hello 👋🏻 {message.from_user.mention} ❤️,\n\nYour Request Has Been Sent to Our Admin's Dashboard.!\nPlease Keep Some Patience..!\nThey Will Upload This Movie 🎥 as Soon as Possible\n\n➟ 🎥 Movie Name : {search}\n➟ 💁🏻 Requested By : {message.from_user.first_name}\n➟ 🤵🏻 User Link :- {message.from_user.mention}\n\n🎥 Get More Movies/Series Files 📂 in <a href=https://t.me/Star_Moviess_Bot><b>Star Movies Bot</b></a>\n\n👨🏻‍✈️ Admin Support :-</b> <a href=https://t.me/Star_Movies_Karthik><b>Karthik</b></a>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("©️ Add me to Your Group", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("📢 Update Channel", url="https://t.me/Star_Moviess_Tamil"), InlineKeyboardButton("👥 Support", url="https://t.me/Star_Movies_Feedback_Bot")],[InlineKeyboardButton("Thank You ❤️ Star Movies Bot", callback_data="close_data")]]))
